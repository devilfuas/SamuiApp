...
import com.psu.samuiapp.FacebookFragment;
...
import com.psu.samuiapp.fragment.event.EventFragment;
...
import com.psu.samuiapp.slidingmenu.CategoryFragment;
import com.psu.samuiapp.slidingmenu.CommunityFragment;
...
//getActionBar().setHomeButtonEnabled(true);
	...
	private void displayView(int position) {
		...
		case 1:
			...
			break;
		case 2:
			startActivity(new Intent(MainActivity.this,MapsFragmentActivity.class));
			break;
		case 3:
		...
		case 4:
			...
			try {
			    Intent intent = getPackageManager().getLaunchIntentForPackage("con.facebook.katana");
			    intent.addCategory(Intent.CATEGORY_LAUNCHER);
			    startActivity(intent);
			} catch (NullPointerException e) {
			    Intent intent = new Intent(Intent.ACTION_VIEW);
			    intent.setData(Uri.parse("market://details?id=" +  "con.facebook.katana"));
			    startActivity(intent);
			}
			break;
		case 5:
